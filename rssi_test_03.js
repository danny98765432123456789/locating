...
client.on('message', function(topic, message) {
  ...
  if (msg.cmd == 'log' && msg.deviceId == '4d0200000000000000000000' && msg.sensorType == 0) { //UIposition  broadcast  log   UIposition
    count++;
    ...
    // console.log("RSSI of 4D03 : "+hexToDec(ConvertBase.dec2hex(msg.data).slice(2,4)) );
